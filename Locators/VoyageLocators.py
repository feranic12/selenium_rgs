...
class VoyageLocators:
    Insured0_Dob_Input = (By.NAME, "content.insConditions.insVariant.insurers[0].dob")
    Trip_Type_Button = (By.CSS_SELECTOR, "div[data-name=\"content.insConditions.insVariant.tripType\"] button:first-child")
    ...
    Trip_Start_Input = (By.NAME, "content.contract.departures")
    Trip_End_Input = (By.NAME, "content.contract.arrival")
    Protection_Needed_Button = (By.CSS_SELECTOR, "div[data-name=\"content.insConditions.insVariant.risks.sport.on\"]")
    ...
    Insured0_Male_Button = (By.CSS_SELECTOR, "div[data-name=\"content.insConditions.insVariant.insurers[0].sex\"] button:first-child")
    ...
    Insurer_Dob_Input = (By.NAME, "content.policyHolder.dob")
